...
variable "zone" {
  ...
  description = <<-EOT
  {
   ...
   "description": "this is the zone where the vm will be created"
}
EOT
}
...
variable "boot_disk_type" {
  description = <<-EOT
  {
   ...
   "description": "this is the boot_disk_type with which the vm will be created"
}
EOT
  type        = string
}
...
variable "create_service_account" {
  ...
  description = <<-EOT
  {
   ...
   "description": "Whether to create service account for the compute instance"
}
EOT
  default     = false
}
